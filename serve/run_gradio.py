...
# 可以选择不同的PERSIST_PATH
# DEFAULT_PERSIST_PATH = "../vector_db/ernie"
...
with block as demo:
    ...
    with gr.Row():
        ...
        llm_btn.click(respond, inputs=[
                      ...
                      llm, 
                      history_len, 
                      temperature], outputs=[msg, chatbot], show_progress="minimal")
        ...
        msg.submit(respond, inputs=[
                   ...
                   llm, 
                   history_len, 
                   temperature], outputs=[msg, chatbot], show_progress="hidden")
